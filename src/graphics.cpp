...
void mazorca::check_vk_result(VkResult err) {
    if (err != VK_SUCCESS) {
        std::println("[vulkan] Error: VkResult = {}", std::to_underlying(err));
    }
}

bool mazorca::isExtensionAvailable(const ImVector<VkExtensionProperties>& properties, const char* extension) {
...
void mazorca::CleanupVulkan(mazorca::vulkan_data& vulkan_data) {
...
void mazorca::CleanupVulkanWindow(mazorca::vulkan_data& vulkan_data) {
...
void mazorca::SetupVulkanWindow(mazorca::vulkan_data& vulkan_data, ImGui_ImplVulkanH_Window* wd, VkSurfaceKHR surface, int width, int height) {
    wd->Surface = surface;
...
void mazorca::FrameRender(mazorca::vulkan_data& vulkan_data, ImGui_ImplVulkanH_Window* wd, ImDrawData* draw_data) {
...
void mazorca::FramePresent(mazorca::vulkan_data& vulkan_data, ImGui_ImplVulkanH_Window* wd) {
